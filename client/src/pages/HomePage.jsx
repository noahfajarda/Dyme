      ...
      {/* <div class="app-left">
        ...
        <ul class="nav-list">
          <li class="nav-list-item active">
            <a class="nav-list-link" href="google.com">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
          ...
          <div class="app-right-section">
            ...
            <div class="activity-line">
              ...
              <div class="activity-text-wrapper">
                ...
                <a class="activity-link" href="google.com">
                  Renew Now
                </a>
              </div>
            </div>
            ...
            <div class="activity-line">
              ...
              <div class="activity-text-wrapper">
                <p class="activity-text">
                  Your teammate, <strong>Wade Wilson</strong> has closed the job
                  post of <strong>IOS Developer</strong>
                </p>
              </div>
            </div>
            <div class="activity-line">
            ...
            <div class="activity-line">
              ...
              <div class="activity-text-wrapper">
                <p class="activity-text">
                  Your teammate, <strong>Wade Wilson</strong> has closed the job
                  post of <strong>Back-End Developer</strong>
                </p>
              </div>
            </div>
            <div class="activity-line">
              ...
              <div class="activity-text-wrapper">
                ...
                <a href="google.com" class="activity-link">
                  Complete Now
                </a>
              </div>
            </div>
